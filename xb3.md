...
#### 本页主问题与引导演示
- 主问题：升高温度后，分子热运动的统计表现怎样？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/molecular-theory.html?lesson=X3-01" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：同种物质的质量加倍，物质的量怎样变化？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/avogadro.html?lesson=X3-02" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
**交互探究。**
<iframe src="anim/xb3/molecular-motion.html?lesson=X3-03" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：两分子从很远处逐渐靠近，分子力如何变化？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/molecular-force.html?lesson=X3-04" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：一定量物质温度升高时，分子平均动能怎样？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/internal-energy.html?lesson=X3-05" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
**交互探究。**
<iframe src="anim/xb3/temperature-scale.html?lesson=X3-06" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：密闭气体体积减小时，若 T、n 不变，压强怎样？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/gas-state-parameters.html?lesson=X3-07" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：玻意耳定律实验中应保持哪个量不变？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/boyle-law.html?lesson=X3-08" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：压强不变时升高绝对温度，气体体积怎样？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/charles-law.html?lesson=X3-09" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
同一团气体可能同时经历体积变化和温度变化：比如气球被加热时体积会变大，封闭气缸被压缩时温度也可能升高。此时只用 `pV=常量` 或 `p/T=常量` 不够，需要用一个同时连接 `p、V、T、n` 的方程，这就是理想气体状态方程。
...
#### 本页主问题与引导演示
- 主问题：同一容器内增加气体物质的量，T、V 不变时 p 怎样？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/gas-state-parameters.html?lesson=X3-10" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：p-V 图中气体膨胀时，对外做功如何读出？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/pv-graph.html?lesson=X3-11" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：一定量理想气体从状态 1 到 2，哪个量由端点唯一决定？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/gas-law.html?lesson=X3-12" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
动画把气体系统画成一个可操作气缸。学生只独立调节热量 `Q` 和末态体积 `V`；外界对气体做功 `W` 由同一条准静态 p-V 直线路径的面积反号计算，不再另设一个可与活塞矛盾的做功滑块。气体装置、路径面积、能量账本和内能槽共享同一状态，并实时核对 `ΔU=Q+W`。

#### 本页主问题与引导演示
- 主问题：气体沿给定 p-V 路径膨胀时，外界对气体做功 W 的符号怎样？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/first-law.html?lesson=X3-13" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
可拖动参数：热量 `Q`、活塞位置 `V`；也可以直接拖动画面里的活塞、`Q` 手柄和 `V` 路径手柄。实时变化：由路径积分得到的 `W`、内能变化 $\Delta U$、能量流向、p-V 面积、压力/体积/温度读数、状态判断和数据记录。

**证据任务。**
- 令末态体积等于初态体积：核对路径面积与 `W` 是否同时为零，再改变 `Q` 观察内能变化。
- 令 $Q=0$ 后压缩气体：看 p-V 面积给出的 `W>0` 是否使内能增加。
- 令 $Q>0$ 后膨胀气体：看 p-V 面积给出的 `W<0` 如何抵消部分吸热。
- 每次拖动活塞都核对 `Wout=面积`、`W=-Wout` 与 $\Delta U=Q+W$，不能把三个读数当成互不相关的输入。
...
**交互探究。**
<iframe src="anim/xb3/second-law.html?lesson=X3-14" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：能量守恒是否意味着所有能量都同样易于利用？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/energy-conservation-thermal.html?lesson=X3-15" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：热量会自发地从低温物体传向高温物体吗？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/second-law.html?lesson=X3-16" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：晶体和非晶体最关键的结构区别是什么？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/crystal-amorphous.html?lesson=X3-17" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
动画显示液面表面分子受力不平衡、细针压弯液面、切向张力和张力计读数。拖动画面中的细针或边界长度尺，液面形变、张力箭头、`F=σL` 读数和临界状态会同步变化。

#### 本页主问题与引导演示
- 主问题：两侧接触线对细针的竖直支持力怎样合成？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/surface-tension.html?lesson=X3-18" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>

> **公式首次使用卡**：适用边界——单侧一条接触线的切向张力大小为 $F=\sigma L$；本页明确采用两条对称接触线、切线与水平夹角为 $\alpha$、忽略浮力的模型，所以竖直支持合力为 $F_y=2\sigma L\sin\alpha$。复杂曲面、接触角和浮力不可省略时需重新建模。符号含义在紧邻公式的正文、图注或表格中定义；除题目另有单位外，代入前统一为 SI，结果保留单位并做量纲检查。

可拖动参数：表面张力系数 $\sigma$、单侧接触线长度 `L`、液面切线角 $\alpha$、物体重力 `G`；也可以直接拖动画面中的细针和边界尺。实时变化：单侧切向张力 $\sigma L$、两侧竖直支持合力 $F_y$、液面形变、能否托住物体和数据记录。

**证据任务。**
- 增大 $\sigma$：看两侧切向张力箭头和竖直合力是否同步增大。
- 增大单侧 `L`：看 $F_y=2\sigma L\sin\alpha$ 是否增大。
- 改变 $\alpha$：核对两侧水平分量抵消、竖直分量相加。
- 增大 `G`：看物体什么时候压破液面。
...
其中 $\sigma$ 是表面张力系数，`L` 是单侧接触线长度。本页两条接触线对称且忽略浮力，竖直方向有 $F_y=2\sigma L\sin\alpha$；是否能托住细针应比较 $F_y$ 与 `G`，不能直接比较 $\sigma L$ 与重力。
...
#### 本页主问题与引导演示
- 主问题：光频率低于截止频率时，只增大光强会有光电子吗？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb1/photoelectric.html?lesson=X3-19" width="100%" height="640" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
动画左侧显示光子束和金属屏，右侧显示实物粒子双缝累积和德布罗意波。屏幕上的每个落点都由双缝概率分布作随机拒绝抽样，不再按点序号生成确定正弦图案；拖动频率探针、光强和动量探针，可比较单次随机落点与大量样本统计条纹。

#### 本页主问题与引导演示
- 主问题：双缝实验中单个粒子的落点能否按固定顺序预言？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/wave-particle.html?lesson=X3-20" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
- 增大粒子动量：看德布罗意波长是否变短。
- 点击“播放”：看单个粒子随机逐点到达屏幕；有限样本会有涨落，只有累积后才呈现统计条纹。
...
#### 本页主问题与引导演示
- 主问题：卢瑟福散射中少数 α 粒子大角偏转说明什么？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/atomic-structure.html?lesson=X3-21" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：电子从高能级跃迁到低能级时发生什么？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/bohr-energy-level.html?lesson=X3-22" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：不同元素的线状光谱为何可作“指纹”？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/atomic-spectrum.html?lesson=X3-23" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
**交互探究。**
<iframe src="anim/xb3/nuclear-structure.html?lesson=X3-24" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：β− 衰变前后质量数 A 和电荷数 Z 如何变化？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/radioactive-decay.html?lesson=X3-25" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：经过两个半衰期后，未衰变核数平均剩多少？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/half-life.html?lesson=X3-26" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：补全核反应方程最先检查哪两个守恒量？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/nuclear-reaction.html?lesson=X3-27" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：质量亏损 Δm 对应的能量由什么关系给出？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/nuclear-energy.html?lesson=X3-28" width="100%" height="560" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
<svg viewBox="0 0 700 250" width="100%" style="max-width:880px">
  ...
  <text x="350" y="236" font-size="15" fill="#102a43" text-anchor="middle" font-weight="700">平均结合能 Eb/A 越大，通常表示核子结合越紧</text>
</svg>

**动态表征。**
动画只提供氘、氦-4、碳-12、氧-16、铁-56、镍-62、铀-235 这组有界核素参考值。拖动曲线探针只能吸附到这些核素，总结合能由 `A×(Eb/A)`、质量亏损由 `Eb/931.5` 派生，不能任意拼接 `A` 与 `Eb`。

#### 本页主问题与引导演示
- 主问题：比较不同核素结合紧密程度应优先看什么？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/binding-energy.html?lesson=X3-29" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
可选参数：当前核素、对比核素；也可以直接拖动画面中的曲线探针并吸附到最近的参考核素。实时变化：派生总结合能、平均结合能、质量亏损、结合紧密程度和数据记录。

**证据任务。**
- 选择不同核素：核对 `Eb=A×(Eb/A)` 与 $\Delta m=E_b/931.5$ 是否由同一参考数据派生。
- 比较两个核的 `Eb/A`：只判断哪个核的核子结合更紧，不据此断言所有衰变通道的稳定性。
- 拖动曲线探针：确认探针只能吸附到已列出的参考核素，不能生成任意 `A` 的伪精确读数。
...
**交互探究。**
<iframe src="anim/xb3/nuclear-fission.html?lesson=X3-30" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
**动态表征。**
动画显示两个带正电轻核从远处靠近。拖动画面里的轻核可改变接近距离；温度和约束只生成“条件不足—改善中—较有利”的定性趋势，不再把未标定的等级换算成聚变概率百分数。

#### 本页主问题与引导演示
- 主问题：提高温度和约束是否足以给出精确聚变概率？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/nuclear-fusion.html?lesson=X3-31" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
可操作内容：直接拖动氘核或氚核改变接近距离，也可调节温度、约束强度和假设反应次数。画面同时显示粒子轨迹、约束侧视、能垒和数据记录，把 $^{2}H+^{3}H\to ^{4}He+n+17.6\ \mathrm{MeV}$、$E=\Delta mc^{2}$ 与条件趋势绑定；真实反应率还需要截面、密度、速度分布和约束时间。

**证据任务。**
- 拖动两个轻核：看距离变小时，只有温度和约束足够时才可能越过电斥能垒。
- 点“播放”：看高温热运动如何推动轻核反复接近并发生聚变。
- 提高温度：看轻核是否更容易克服电斥力靠近。
- 提高约束强度：看条件趋势是否改善，但不要把等级读数当成反应概率。
- 增加反应次数：看总能量如何累加。
...
#### 本页主问题与引导演示
- 主问题：某反应满足电荷守恒，能否据此断言通道一定成立？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/particle-physics.html?lesson=X3-32" width="100%" height="760" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
- 拖动粒子卡进入反应室：电荷差值不为零时可以排除通道；差值归零时只说明电荷守恒这一必要条件满足，还必须检查能量、动量、角动量等条件。
...
#### 本页主问题与引导演示
- 主问题：温度升高而分子质量不变，速率分布怎样变化？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/molecular-speed-distribution.html?lesson=X3-33" width="100%" height="820" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
#### 本页主问题与引导演示
- 主问题：布朗运动的均方位移曲线应怎样得到？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/diffusion-brownian.html?lesson=X3-34" width="100%" height="720" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
- 对照均方位移图：每个点由 72 个随机行走样本的位移平方取平均，有限样本会涨落，不是预设的平滑曲线。
...
#### 本页主问题与引导演示
- 主问题：液晶、半导体、纳米材料的性质主要由什么决定？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/materials-microstructure.html?lesson=X3-35" width="100%" height="720" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
- 知道接触角小于 `90°` 时常出现毛细上升，大于 `90°` 时可出现毛细下降。
- 理解管径越小，毛细升降越明显。
...
#### 本页主问题与引导演示
- 主问题：接触角恰为 90° 时，理想毛细高度怎样？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/capillary.html?lesson=X3-36" width="100%" height="720" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
- 拖动接触角手柄：分别检查 $\theta <90^{\circ}$、$\theta =90^{\circ}$、$\theta >90^{\circ}$ 的上升、临界不升不降、下降三种状态。
...
#### 本页主问题与引导演示
- 主问题：古木测年应把 14C 半衰期放在哪个时间尺度？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/radioisotope-applications.html?lesson=X3-37" width="100%" height="720" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>
...
**证据任务。**
- 切换医学示踪、工业探伤、考古测年：核对核素与时间轴分别切换为 `99mTc/小时`、`60Co/年`、`14C/年`。
- 拖动探测器：看强度随位置和屏蔽变化。
- 拖动时间手柄：看剩余比例按半衰期衰减，并确认 `t` 与 `T` 始终使用同一单位；古木测年使用约 5730 年而不是小时轴。
...
#### 本页主问题与引导演示
- 主问题：仅凭本页相对响应能否判断实际辐射剂量安全？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/radiation-protection.html?lesson=X3-38" width="100%" height="720" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>

**证据任务。**
- 切换 α、β、γ：比较穿透和电离能力表盘。
- 拖动探测器：只比较距离增大后相对探测响应下降的趋势，不把它称为已标定剂量。
- 拖动屏蔽厚度：看不同射线被削弱程度不同。
- 调暴露时间：理解时间越长通常会增加暴露；是否安全还必须给出源活度、能谱、材料衰减和剂量标定。

#### 规律、证据与核心概念

```text
防护三原则：时间短、距离远、屏蔽强
定性趋势：相对响应随 t 增、随 d 增而减，屏蔽效果取决于射线和材料
边界：本页不输出剂量值或安全阈值
α：电离强，穿透弱
β：中等穿透
γ：穿透强，需厚屏蔽
...
#### 本页主问题与引导演示
- 主问题：判断主导相互作用时，尺度能否脱离对象单独分类？
- 先独立选择预测并说明理由；验证前遮蔽动画读数和公式。
- 验证时只改变本节指定变量，观察一个直接证据；验证后再开放解释、模型边界、迁移和自由探索。

**交互探究。**
<iframe src="anim/xb3/fundamental-interactions.html?lesson=X3-39" width="100%" height="720" frameborder="0" style="border:1px solid #d9e2ec;border-radius:8px"></iframe>

**证据任务。**
- 先切换对象/过程：核内束缚、β 衰变、带电粒子、天体轨道分别对应强、弱、电磁、引力相互作用。
- 再拖动尺度探针：只检查所选对象与尺度是否自洽；单独改变尺度不会改写对象给出的主导作用。
